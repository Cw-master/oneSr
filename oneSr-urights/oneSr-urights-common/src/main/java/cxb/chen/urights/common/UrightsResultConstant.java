 ...
 * @author chen
 */
public enum UrightsResultConstant {
    ...
    UrightsResultConstant(int code, String message) {
        this.code = code;
    ...
    /*public static void main (String []args) {
        for (UrightsResultConstant urightsResultConstant: UrightsResultConstant.values()) {
            System.out.println(urightsResultConstant.code);
        }
    }*/
}
