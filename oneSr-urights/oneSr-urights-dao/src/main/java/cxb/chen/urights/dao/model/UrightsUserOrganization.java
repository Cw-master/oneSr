package cxb.chen.urights.dao.model;

import java.io.Serializable;

public class UrightsUserOrganization implements Serializable {
    /**
     * 编号
     *
     * @mbg.generated
    ...
    public boolean equals(Object that) {
        ...
        UrightsUserOrganization other = (UrightsUserOrganization) that;
